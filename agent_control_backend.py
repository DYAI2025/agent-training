...
async def get_root():
    """Serve the frontend"""
    frontend_path = os.path.join(project_root, "agent_control_ui", "frontend", "index.html")
...
async def get_agents():
    ...
    print("GET /api/agents called")
    if not agent_network:
        print("Agent network not initialized")
    ...
    print(f"Returning {len(agents)} agents")
...
async def start_workflow(request: WorkflowRequest):
    ...
    print(f"=== DIAGNOSTIC: Workflow start request received ===")
    print(f"Request data: {request.customer_request}")
    print(f"Quality threshold: {request.quality_threshold}")
    
    if not agent_network:
        print("=== DIAGNOSTIC: Agent network not initialized ===")
        return {"error": "Agent network not initialized"}
    ...
    try:
        ...
        print(f"=== DIAGNOSTIC: Agent states updated to initializing ===")
        ...
        print(f"=== DIAGNOSTIC: Calling agent_network.process_customer_request ===")
        print(f"Input customer_request type: {type(request.customer_request)}")
        print(f"Input customer_request: {request.customer_request}")
        ...
        print(f"=== DIAGNOSTIC: Workflow completed ===")
        ...
        print(f"=== DIAGNOSTIC: Workflow error ===")
